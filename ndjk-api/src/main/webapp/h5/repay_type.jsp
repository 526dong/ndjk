...
<html lang="en">
  <head>
    <meta charset="UTF-8"/>
    <title>还款方式</title>
    <meta name="keywords" content="借款,小额借款,借款app,急用钱,短期快速放款,极速借款">
  ...
  <body>
    ...
    <ul>
      ...
      <li>邮政储蓄银行卡不支持自动扣款，怎么办?
        <p>可通过支付宝还款或打款至对公账号两种方式进行还款。对公银行账号为<span class='bank'></span>，还款后请与客服取得联系【客服邮箱：kefu@fuyinhy.com】，将注册用户手机号、转账金额和转入银行卡信息截图提供给客服。客服电话：<span class='phone'></span>（工作日9:00-18:00）</p>
      </li>
    </ul>
  </div>
