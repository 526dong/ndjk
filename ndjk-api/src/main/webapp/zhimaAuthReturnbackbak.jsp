<%@ page import="com.rongdu.cashloan.core.common.context.Global" %>
...
<%
    ...
    String error_code = ((Integer) request.getAttribute("code")).equals(200) ? "SUCCESS" : "failed";
    String serverHost = Global.getValue("server_host");
    response.sendRedirect(serverHost+"/h5/result_status.html?params=api/actzm/mine/zhima/AuthCallBack.htm&error_code=" + error_code);
%>
