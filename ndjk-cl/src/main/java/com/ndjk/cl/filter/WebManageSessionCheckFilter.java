...
/**
 * Created by zfwlz on 2018/1/30.
 */
@Component
public class WebManageSessionCheckFilter implements Filter{
     ...
     * Default constructor.
     */
    public WebManageSessionCheckFilter() {
    ...
    private boolean checkSession(HttpServletRequest r) {
        ...
        try {
            SysUser sysUser= (SysUser) cursession.getAttribute("sysUser");
            if (null == sysUser) {
                return false;
            }
            return true;
